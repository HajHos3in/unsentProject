        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 py-3 ">
            ...
            <div class="col p-2 message-box">
                <div class="h-100 d-flex flex-column border border-2 border-dark py-2 px-3 fw-bold position-relative overflow-auto shabnam">
                    ...
                    <div class="p-3 text-break text-justify bg-danger text-light font-size-24 lh-lg my-1 overflow-hidden" dir="auto" style="flex: 1 1 auto;">
                        تجربه به من ثابت کرده است که ۱۲۸ کاراکتر برای یک همچین پیامی کافی است اما من ۱۲۸ کاراکتر تنظیم میکنم.
                    </div>
            ...
            <div class="col p-2 message-box">
                <div class="h-100 d-flex flex-column border border-2 border-dark py-2 px-3 fw-bold position-relative overflow-auto shabnam">
                    ...
                    <div class="p-3 text-break text-justify bg-danger text-light font-size-24 lh-lg my-1 overflow-hidden" style="flex: 1 1 auto;">
                        تجربه به من ثابت کرده است که ۱۲۸ کاراکتر برای یک همچین پیامی کافی است اما من ۱۲۸ کاراکتر تنظیم میکنم.
                    </div>
